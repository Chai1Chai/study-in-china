  ...
  return (
    <div className="flex flex-col mb-4">
      <button
        ...
        className={`w-full bg-white p-5 md:p-6 flex justify-between items-center text-left transition-all duration-300 ${
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            <div className="p-5 md:p-6 pt-0 text-[#4A2418]/70 text-sm md:text-base leading-relaxed border-t border-gray-100 mx-5">
              {answer}
            </div>
          </motion.div>
        )}
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 max-w-7xl">
        <h2 className={`${mm9Prose.className} text-white text-3xl md:text-6xl font-medium text-center mb-16 font-serif`}>
