...
const ExperienceSection = () => {
  ...
  return (
    <section className="relative w-full overflow-hidden">
      ...
      >
        <h2 className={`${mm9Prose.className} text-5xl md:text-8xl font-serif text-[#636024]`}>Мой опыт!</h2>
      ...
      <div className="relative z-10 grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-12 items-start">
        ...
        <div 
          className="bg-[#FCFDED] md:hidden md:col-span-12 p-6 md:p-12 text-center text-sm font-semibold  md:text-base leading-relaxed text-[#4a4a2a] border-2 border-[#636024]/20 rounded-2xl md:border-0"
  >
        ...
        <div className="block md:hidden space-y-4">
          <div className="bg-[#FCFDED] border-2 border-[#636024]/20 rounded-xl p-4">
            <button onClick={() => toggleAccordion(0)} className="w-full flex justify-between items-center font-bold text-[#7a3015]">
          ...
          <div className="bg-[#FCFDED] border-2 border-[#636024]/20 rounded-xl p-4">
            <button onClick={() => toggleAccordion(1)} className="w-full flex justify-between items-center font-bold text-[#7a3015]">
          ...
          <div className="bg-[#FCFDED] border-2 border-[#636024]/20 rounded-xl p-4">
            <button onClick={() => toggleAccordion(2)} className="w-full flex justify-between items-center font-bold text-[#7a3015]">
              <span>Мифы</span>
            ...
            {openIndex === 2 && (
              <p className="mt-2 text-sm">
                ...
                <p>«С вашим уровнем языка возьмут куда угодно» — <span className="text-[#7a3015]">это миф</span></p>
              </p>
            )} 
          </div>
        </div>
