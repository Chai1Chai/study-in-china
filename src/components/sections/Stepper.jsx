...
const Stepper = () => {
  return (
    <section className="relative w-full mb-20 bg-cover bg-center px-4 md:px-16 lg:px-24 xl:px-32"
    style={{backgroundImage:`url(${StepperImage.src})` }}
    >
      <h2 className={`${montserrat.className} text-4xl md:text-6xl leading-[60px] md:leading-[84px] font-normal mb-24 text-[#5E0F08] text-center`}>
        Этапы сопровождения
      </h2>
...
const Step = ({ step, number }) => {
  ...
  return (
    <div ref={ref} className="flex items-start md:items-center relative">
      ...
      <div
        className={`${montserrat.className} md:-mt-10 w-12 h-12 md:w-15 md:h-15 min-w-[48px] min-h-[48px] flex items-center justify-center rounded-full bg-[#5E0F08] text-white text-lg font-normal z-10 transition-all duration-700 ${
