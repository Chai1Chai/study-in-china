...
const ContactBlock = () => {
  return (
    <section className={`${montserrat.className} w-full flex justify-center py-10 px-4 md:px-16 lg:px-24 xl:px-32 relative overflow-hidden`}>
      ...
      <div className="z-10 max-w-6xl w-full flex flex-col md:flex-row items-center md:items-start justify-center gap-20 px-4">
        ...
        <div className="relative order-1 md:order-2 bg-[#EEE9CB] rounded-[30px] px-8 py-10 w-full max-w-md text-center">
          ...
          <div className="flex flex-col gap-4">
            ...
            >
              <img src={tgicon.src} alt="tg" className="absolute left-6 w-5 invert brightness-0" />
            ...
            >
              <img src={vkicon.src} alt="vk" className="absolute left-6 w-5 invert brightness-0" />
