  ...
  return (
    <footer className={`${montserrat.className} bg-[#5E0F08] text-white px-4 md:px-16 lg:px-24 xl:px-32 py-16`}>
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12">
        ...
        <div>
          <h3 className="hidden md:flex text-xl mb-6 font-semibold">Навигация</h3>

          <ul className="hidden md:flex flex-col gap-3 text-sm text-white/80">
            <li>
              <a href="#hero" className="hover:text-white transition-colors duration-200">Главная</a>
            </li>
            <li>
              <a href="#services" className="hover:text-white transition-colors duration-200">Услуги</a>
            </li>
            <li>
              <a href="#about-me" className="hover:text-white transition-colors duration-200">Обо мне</a>
            </li>
            <li>
              <a href="#support" className="hover:text-white transition-colors duration-200">О работе</a>
            </li>
            <li>
              <a href="#universities" className="hover:text-white transition-colors duration-200">Вузы</a>
            </li>
            <li>
              <a href="#testimonial" className="hover:text-white transition-colors duration-200">Отзывы</a>
            </li>
            <li>
              <a href="#faq" className="hover:text-white transition-colors duration-200">Вопросы</a>
            </li>
            <li>
              <a href="#contact-block" className="hover:text-white transition-colors duration-200">Контакты</a>
            </li>
          </ul>
        </div>
          ...
          <div>
            ...
            <div className="flex gap-4 mb-6">
                <a
                  ...
                  className="w-10 h-10 rounded-lg bg-white flex items-center justify-center hover:scale-105 transition"
                >
                  <img src={YoutubeImage.src} alt="telegram" className="w-6 h-6" />
                </a>
                <a
                ...
                <a
                  ...
                  className="w-10 h-10 rounded-lg bg-white flex items-center justify-center hover:scale-105 transition"
                >
                  <img src={TiktokImage.src} alt="telegram" className="w-5 h-5" />
                </a>
            </div>
          </div>
          <div className="mt-4">
            ...
            <div className="flex items-center gap-4">
                <a
                  ...
                  className="w-10 h-10 rounded-lg bg-white flex items-center justify-center hover:scale-105 transition"
                >
                  <img src={EnvelopeImage.src} alt="telegram" className="w-5 h-5" />
                </a>
                <span>
