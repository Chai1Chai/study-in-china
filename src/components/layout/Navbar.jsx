    ...
    return (
        <div className="font-[Montserrat]">
            ...
            ${isScrolled 
                ...
                <div className="hidden md:flex items-center gap-6 lg:gap-10">
                    {navLinks.map((link, i) => (
                        <a 
                            key={i} 
                            href={link.path} 
                            className="group relative text-[#636024] transition-colors duration-300 hover:text-[#5C0F07]"
                        >
                            {link.name}                           
                ...
                <a href="/" className="flex items-center gap-2">
                    <span className="text-lg text-[#5C0F07]">+7 999 000 000</span>
                </a>
                ...
                {/* Mobile Menu */}
                <div className={`fixed top-0 left-0 w-full h-screen bg-[#FCF9EA] flex flex-col items-center justify-center gap-6 transition-all duration-500
